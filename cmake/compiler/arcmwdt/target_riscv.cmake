...
elseif(DEFINED CONFIG_SOC_SERIES)
  # Fallback to string only if present (keeps behavior deterministic via Kconfig).
  if(CONFIG_SOC_SERIES STREQUAL "rpx")
    set(ARCMWDT_RISCV_CORE -av5rpx)
  elseif(CONFIG_SOC_SERIES STREQUAL "rmx")
    set(ARCMWDT_RISCV_CORE -av5rmx)
  elseif(CONFIG_SOC_SERIES STREQUAL "rhx")
    set(ARCMWDT_RISCV_CORE -av5rhx)
  endif()
endif()
