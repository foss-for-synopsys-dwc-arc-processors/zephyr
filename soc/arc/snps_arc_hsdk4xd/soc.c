...
static int arc_hsdk4xd_init(const struct device *dev)
{
	ARG_UNUSED(dev);
	...
	/* allocate all IDU interrupts to primary core */
...
SYS_INIT(arc_hsdk4xd_init, PRE_KERNEL_1, CONFIG_KERNEL_INIT_PRIORITY_DEFAULT);
