...
union ic_con_register {
	u32_t                raw;
	struct {
		u32_t         master_mode : 1 __packed;
		u32_t         speed : 2 __packed;
		u32_t         addr_slave_10bit : 1 __packed;
		u32_t         addr_master_10bit : 1 __packed;
		u32_t         restart_en : 1 __packed;
		u32_t         slave_disable : 1 __packed;
		u32_t         stop_det : 1 __packed;
		u32_t         tx_empty_ctl : 1 __packed;
		u32_t         rx_fifo_full : 1 __packed;
	} bits;
};
...
union ic_interrupt_register {
	u32_t			raw;
	struct {
		u32_t	rx_under : 1 __packed;
		u32_t	rx_over : 1 __packed;
		u32_t	rx_full : 1 __packed;
		u32_t	tx_over : 1 __packed;
		u32_t	tx_empty : 1 __packed;
		u32_t	rd_req : 1 __packed;
		u32_t	tx_abrt : 1 __packed;
		u32_t	rx_done : 1 __packed;
		u32_t	activity : 1 __packed;
		u32_t	stop_det : 1 __packed;
		u32_t	start_det : 1 __packed;
		u32_t	gen_call : 1 __packed;
		u32_t	restart_det : 1 __packed;
		u32_t	mst_on_hold : 1 __packed;
		u32_t	reserved : 2 __packed;
	} bits;
};
...
union ic_tar_register {
	u32_t		raw;
	struct {
		u32_t	ic_tar : 10 __packed;
		u32_t	gc_or_start : 1 __packed;
		u32_t	special : 1 __packed;
		u32_t	ic_10bitaddr_master : 1 __packed;
		u32_t	reserved : 3 __packed;
	} bits;
};
