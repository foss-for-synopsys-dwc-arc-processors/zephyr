...
uint32_t ss_crypto_tc_aes_set_encrypt_key(TCAesKeySched_t s, const uint8_t *key)
{
...
uint32_t ss_crypto_tc_aes_set_decrypt_key(TCAesKeySched_t s, const uint8_t *key)
{
	uint32_t ret = TC_CRYPTO_FAIL;
...
{
	switch(ops){
		case SS_TINYCRYPT_OP_AES_SET_ENCRYPT_KEY:
			return ss_crypto_tc_aes_set_encrypt_key((TCAesKeySched_t)arg1,
														(uint8_t *)arg2);
		case SS_TINYCRYPT_OP_AES_SET_DECRYPT_KEY:
			return ss_crypto_tc_aes_set_decrypt_key((TCAesKeySched_t)arg1,
														(uint8_t *)arg2);
		case SS_TINYCRYPT_OP_AES_ENCRYPT:
			return ss_crypto_tc_aes_encrypt((TCAesKeySched_t)arg1,
									(uint8_t *)arg2, (uint8_t *)arg3);

		case SS_TINYCRYPT_OP_AES_DECRYPT:
			return ss_crypto_tc_aes_decrypt((TCAesKeySched_t)arg1,
									(uint8_t *)arg2, (uint8_t *)arg3);

		case SS_TINYCRYPT_OP_AES_CTR_CRYPT:
			return ss_crypto_tc_aes_ctr_crypt((TCAesKeySched_t)arg1,
		...
		case SS_TINYCRYPT_OP_AES_CBC_ENCRYPT:
			return ss_crypto_tc_aes_cbc_encrypt((TCAesKeySched_t)arg1,
		(ss_crypto_data_ptr)arg2, (uint8_t *)arg3, (ss_crypto_data_ptr)arg4);

		case SS_TINYCRYPT_OP_AES_CBC_DECRYPT:
			return ss_crypto_tc_aes_cbc_decrypt((TCAesKeySched_t)arg1,
		(ss_crypto_data_ptr)arg2, (uint8_t *)arg3, (ss_crypto_data_ptr)arg4);

		case SS_TINYCRYPT_OP_AES_CCM_CONFIG:
			return ss_crypto_tc_aes_ccm_config((TCCcmMode_t)arg1,
				(TCAesKeySched_t)arg2, (ss_crypto_data_ptr)arg3, arg4);
...
uint32_t ss_crypto_tc_aes_set_encrypt_key(TCAesKeySched_t s, const uint8_t *key)
{
	return z_arc_s_call_invoke6((uint32_t)s, (uint32_t)key, 0, 0,
				SS_TINYCRYPT_OP_AES_SET_ENCRYPT_KEY, 0, ARC_S_CALL_CRYPTO);
}

uint32_t ss_crypto_tc_aes_set_decrypt_key(TCAesKeySched_t s, const uint8_t *key)
{
	return z_arc_s_call_invoke6((uint32_t)s, (uint32_t)key, 0, 0,
				SS_TINYCRYPT_OP_AES_SET_DECRYPT_KEY, 0, ARC_S_CALL_CRYPTO);
}

uint32_t ss_crypto_tc_aes_encrypt(TCAesKeySched_t s, const uint8_t *in,
										uint8_t *out)
{
	return z_arc_s_call_invoke6((uint32_t)s, (uint32_t)in, (uint32_t)out,
...
uint32_t ss_crypto_tc_aes_ctr_crypt(TCAesKeySched_t s, ss_crypto_data_ptr in,
										uint8_t *ctr, ss_crypto_data_ptr out)
{
	return z_arc_s_call_invoke6((uint32_t)s, (uint32_t)in, (uint32_t)ctr,
...
uint32_t ss_crypto_tc_aes_cbc_encrypt(TCAesKeySched_t s, ss_crypto_data_ptr in,
									const uint8_t *iv, ss_crypto_data_ptr out)
{
	return z_arc_s_call_invoke6((uint32_t)s, (uint32_t)in, (uint32_t)iv,
...
{
	return z_arc_s_call_invoke6((uint32_t)c, (uint32_t)s, (uint32_t)nonce,
