...
#define LSTM2_W_OUT_SHAPE                                                      \
	{                                                                      \
		4, 32, 32                                                      \
	}
#define LSTM2_W_OUT_MEM_STRIDE                                                 \
	{                                                                      \
		32 * 32, 32, 1                                                 \
	}
...
#define LSTM3_W_OUT_SHAPE                                                      \
	{                                                                      \
		4, 32, 32                                                      \
	}
#define LSTM3_W_OUT_MEM_STRIDE                                                 \
	{                                                                      \
		32 * 32, 32, 1                                                 \
	}
