...
static volatile int isr_count_cpu0 = 0;
static volatile int isr_count_cpu1 = 0;

/* Broadcast test counters */
static volatile int broadcast_cpu0 = 0;
static volatile int broadcast_cpu1 = 0;
...
static volatile bool cpu1_init_done = false;
static volatile bool cpu1_init_success = false;
